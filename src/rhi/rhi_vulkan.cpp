...
std::string Vulkan::get_result_str(VkResult r) {
...
static const VkFormat format_map[(int)RHIFormat::MAX] = {
...
VkFormat Vulkan::get_format(RHIFormat format) {
	return format_map[(int)format];
}